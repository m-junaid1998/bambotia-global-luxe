          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="relative aspect-[4/5] overflow-hidden rounded-sm mb-4">
              ...
              {product.regularPrice && product.regularPrice > product.price && (
                <div className="absolute bottom-3 left-3 bg-red-500/90 backdrop-blur-sm text-white px-3 py-1.5 rounded-md text-sm font-semibold shadow-md">
                  -{getDiscountPercent(product.regularPrice, product.price)}%
                  OFF
                </div>
              )}
            </div>
